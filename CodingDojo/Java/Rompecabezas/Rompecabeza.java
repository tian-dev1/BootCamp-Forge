...
public class Rompecabeza {
    ...
    public void shuffleAlphabet(){
        ...
        System.out.println("Primera letra del array: " + alphaArr.get(0));
        System.out.println("Ultima letra del array: " + alphaArr.get(25));
    ...
    public void randNumber2(){
        ...
        System.out.println("El número aleatorio más pequeño es: " + min);
        System.out.println("El número aleatorio más grande es: " + max);
    }
